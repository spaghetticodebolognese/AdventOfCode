...
public class Main {
    public static void main(String[] args) {
        ...
        //System.out.println(trebuchetCalibrationValue(input));

            String[] splittedInput = input.split("\n");

        for(String eintrag : splittedInput){
            System.out.println(trebuchetCalibrationValue(eintrag));
        }
    ...
    public static String trebuchetCalibrationValue(String input) {
        ...
        for (int i = 0; i < charArray.length; i++) {
            if (Character.isDigit(charArray[i]) && firstNum == -1) {
                ...
                //System.out.println("First Num: " + charArray[i]);
            }
        }
        for (int j = charArray.length-1; j > 0; j--) {
            if (Character.isDigit(charArray[j]) && secondNum == -1) {
                secondNum = charArray[j];
                //System.out.println("Second Num: " + charArray[j]);
            }
        }
